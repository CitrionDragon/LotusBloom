...
public class Shade: Impostor, IRoleUI
{
    ...
    public override bool TryKill(PlayerControl target)
    {
        ...
        CustomRole newRole = NormalStandardGameMode.Instance.RoleManager.GetCleanRole(myRole);
        ...
        newRole = NormalStandardGameMode.Instance.RoleManager.GetCleanRole(targetRole);
